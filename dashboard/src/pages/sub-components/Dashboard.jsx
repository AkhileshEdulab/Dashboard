      ...
      <div className='flex flex-col sm:gap-4 sm:py-4 sm:pl-14'>
        <main className='grid flex-1 items-start gap-4 p-4 sm:px-6 sm:py-0 md:gap-8 lg:grid-cols-2 xl:grid-cols-2'>
          <div className='grid auto-rows-max items-start gap-4 md:gap-8 lg:col-span-2'>
            <div className='grid gap-4 sm:grid-2-cols-2 md:grid-cols-4 lg:grid-cols-2 xl:grid-cols-4'>
              ...
              <Card className='flex flex-col justify-center'>
                <CardHeader className='pb-2'>
                  ...
                  <CardTitle>{projects?.length || 0}</CardTitle>
                </CardHeader>
                <CardFooter>
              ...
              <Card className='flex flex-col justify-center'>
                <CardHeader className='pb-2'>
                  ...
                  <CardTitle>{skills?.length || 0}</CardTitle> 
                </CardHeader>
                <CardFooter>
                ...
                <Card>
                  ...
                  <CardContent className='grid sm:grid-cols-2 gap-4'>
                    { 
                      ...
                      ):( <p className='text-3xl overflow-y-hidden'>You have not added any Project</p>)
                    }
                  </CardContent>
                </Card>
              </TabsContent>
                                ...
                                softwareApplication.map((element)=>{
                                  return(
                                    <TableRow className='bg-accent' key={element._id}>
                                      ...
                                      <TableCell><img src = {element.svg && element.svg.url} alt={element.name} className='w-7 h-7'/></TableCell>
                                      <TableCell>
                                         {
                                           loading && appId === element._id ? (
                                             <SpacialLoadingButton content={"Deleting"} width={"w-fit"} />
                                           ) : (
                                             <Button onClick={() => handelDeleteSoftwareApp(element._id)}>Delete</Button>
                                           )
                                         }
                                       </TableCell>
                                    </TableRow>
                                  ...
                                  <TableCell className='text-3xl overflow-hidden'> You hav not added any softwareApplication</TableCell>
                                </TableRow>
